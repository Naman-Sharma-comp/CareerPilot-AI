    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      >
        ...
        <img
          src={robot}
          alt="AI Robot"
          className="w-40 sm:w-56 lg:w-72 mt-8 sm:mt-12"
        />
      </div>

      {/* Register Form */}

      <div className="flex justify-center items-center bg-gray-50 p-4 sm:p-6">
        <div
          className="
            w-full
            max-w-md
        ...
        >
          ...
          <p className="flex justify-center items-center gap-2 text-center text-gray-500 mt-2">
            Join CareerPilot AI
            <Rocket size={18} />
          </p>
